...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //abrir a fragmentPrincipal

        FragmentTransaction fragTrans = getSupportFragmentManager().beginTransaction();
        fragTrans.replace(R.id.frameContainer,principalFragment);
        fragTrans.commit();
    ...
    public void onBackPressed() {
        ...
        } if ( !principalFragment.isResumed()){
            FragmentTransaction fragTrans = getSupportFragmentManager().beginTransaction();
            fragTrans.replace(R.id.frameContainer,principalFragment);
            fragTrans.commit();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_principal) {
            ...
            FragmentTransaction fragTrans = getSupportFragmentManager().beginTransaction();
            fragTrans.replace(R.id.frameContainer,formFragment);
            fragTrans.commit();
    ...
    public void enviarEmail(){
        ...
        email.putExtra(Intent.EXTRA_EMAIL, new String[]{"observacampina@gmail.com"});
        email.putExtra(Intent.EXTRA_SUBJECT, "Casa Legal-PMCG");
        email.putExtra(Intent.EXTRA_TEXT, "Mensagem do App");

        //configurar apps para enviar mensagens.
